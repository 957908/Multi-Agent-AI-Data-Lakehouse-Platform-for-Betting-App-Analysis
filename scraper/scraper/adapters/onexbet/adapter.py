...
File: adapter.py
Purpose:
    Concrete adapter implementing data acquisition lifecycle for 1xBet.
...
# Setup Logger
logger = logging.getLogger("scraper.adapters.onexbet.adapter")


class OneXBetAdapter(BaseAdapter):
    """
    Adapter implementing 1xBet navigation flows and payment discoveries.
    """
    ...
    def navigate_to_deposit(self) -> None:
        ...
        """
        logger.info("Navigating to 1xBet deposit panel...")
        nav_mgr = NavigationManager(self.page)
        try:
