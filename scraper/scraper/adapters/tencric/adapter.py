...
File: adapter.py
Purpose:
    Concrete adapter implementing data acquisition lifecycle for 10Cric.
...
# Setup Logger
logger = logging.getLogger("scraper.adapters.tencric.adapter")


class TenCricAdapter(BaseAdapter):
    """
    Adapter implementing 10Cric navigation flows and payment discoveries.
    """
    ...
    def navigate_to_deposit(self) -> None:
        ...
        """
        logger.info("Navigating to 10Cric deposit panel...")
        nav_mgr = NavigationManager(self.page)
        try:
            ...
            deposit_url = f"{self.base_url}/deposit/"
